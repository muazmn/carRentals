<div class="container rentals">
    ...
    <article class="leaderboard">
        <header>
            ...
            <h1 class="leaderboard__title"><span class="leaderboard__title--top">Rentals</span><span class="leaderboard__title--bottom">Leaderboard</span></h1>
        </header>
        <main class="leaderboard__profiles">
            <?php foreach ($data['user'] as $user) : ?>
                <article class="leaderboard__profile">
                    <img src="https://source.unsplash.com/random/200x200/?<?= $user['avatar']; ?>
" alt="Mark Zuckerberg" class="leaderboard__picture">
